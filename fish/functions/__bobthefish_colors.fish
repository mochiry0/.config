function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
  switch "$color_scheme"
    ...
    case '*' # default dark theme
      ...
      set -l red      cc9999 ce000f 660000
      set -l green    addc10 189303 0c4801
      set -l blue     48b4fb 5faeed 255e87
      set -l orange   f6b117 unused 3a2a03
      set -l brown    bf5e00 803f00 4d2600
      set -l grey     cccccc 999999 333333
      set -l white    ffffff
      ...
      set -x color_path                     $blue[2] $black
      set -x color_path_basename            $blue[2] $black --bold
      set -x color_path_nowrite             $blue[2] $black
      set -x color_path_nowrite_basename    $blue[2] $black --bold
      ...
      set -x color_desk                     $blue[2] $grey[1] --bold
      set -x color_os_icon                  $black $white --bold
      set -x color_right                    $black $white 
      set -x color_exit_status              $black $green[2]
      set -x color_exit_error               $black $red[2]
      set -x color_bb                       $black $grey_bb
  end
end
